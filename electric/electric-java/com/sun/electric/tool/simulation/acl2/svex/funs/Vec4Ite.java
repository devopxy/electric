 ...
 */
public class Vec4Ite<V extends Svar> extends SvexCall<V>
{
    ...
    public Vec4Ite(Svex<V> test, Svex<V> then, Svex<V> els)
    {
    ...
    public static class Function extends SvexFunction
    {
        ...
        @Override
        public <V extends Svar> Vec4Ite<V> build(Svex<V>... args)
        {
